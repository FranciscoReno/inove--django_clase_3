...
class ComicsAdmin(admin.ModelAdmin):
    ...
    # NOTE: Para seleccionar los campos que queremos que el administrativo pueda editar
...
class WishListsAdmin(admin.ModelAdmin):
    # NOTE: Para seleccionar los campos en la tabla de registros
    list_display = ('user_id','comic_id', 'cart', 'wished_qty', 'buied_qty')
    ...
    # NOTE: Para seleccionar los campos que queremos que el administrativo pueda editar
    # fields = ('cart', 'wished_qty', 'buied_qty')
